...
class Result:
    ...
    def run_benchmark(self, df, task, df_name, leader, options):
        ...
        if(task == 'classification'):
            ...
            new_row_pipelines_class = {'dataset': df_name, 'autosklearn': res_as[2], 'tpot': res_t[2], 'autokeras': res_ak[2], 'h2o': res_h[2], 'autogluon': res_ag[2]}
            ...
            new_row_pipelines_reg = {'dataset': df_name, 'autosklearn': res_as[2], 'tpot': res_t[2], 'autokeras': res_ak[2], 'h2o': res_h[2],'autogluon': res_ag[2]}
